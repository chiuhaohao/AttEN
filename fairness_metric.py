...
def compute_fairness_metrics_groupwise(label_list, y_pred_list, group_list, zero_division=0, average='macro'):
    ...
    true_sum = tp + fn
    weights = true_sum
    group1_precision = metrics.precision_score(label_list[group_list==1], y_pred_list[group_list==1], average=average)#, zero_division=0
    group1_recall = metrics.recall_score(label_list[group_list==1], y_pred_list[group_list==1], average=average)#, zero_division=0
    group1_f1_score = metrics.f1_score(label_list[group_list==1], y_pred_list[group_list==1], average=average)#, zero_division=0
    group1_accuracy = metrics.accuracy_score(label_list[group_list==1], y_pred_list[group_list==1])

    group2_precision = metrics.precision_score(label_list[group_list==2], y_pred_list[group_list==2], average=average)#, zero_division=0
    group2_recall = metrics.recall_score(label_list[group_list==2], y_pred_list[group_list==2], average=average)#, zero_division=0
    group2_f1_score = metrics.f1_score(label_list[group_list==2], y_pred_list[group_list==2], average=average)#, zero_division=0
    group2_accuracy = metrics.accuracy_score(label_list[group_list==2], y_pred_list[group_list==2])
    
    group3_precision = metrics.precision_score(label_list[group_list==3], y_pred_list[group_list==3], average=average)#, zero_division=0
    group3_recall = metrics.recall_score(label_list[group_list==3], y_pred_list[group_list==3], average=average)#, zero_division=0
    group3_f1_score = metrics.f1_score(label_list[group_list==3], y_pred_list[group_list==3], average=average)#, zero_division=0
    group3_accuracy = metrics.accuracy_score(label_list[group_list==3], y_pred_list[group_list==3])
    
    group4_precision = metrics.precision_score(label_list[group_list==4], y_pred_list[group_list==4], average=average)#, zero_division=0
    group4_recall = metrics.recall_score(label_list[group_list==4], y_pred_list[group_list==4], average=average)#, zero_division=0
    group4_f1_score = metrics.f1_score(label_list[group_list==4], y_pred_list[group_list==4], average=average)#, zero_division=0
    group4_accuracy = metrics.accuracy_score(label_list[group_list==4], y_pred_list[group_list==4])
    
    group5_precision = metrics.precision_score(label_list[group_list==5], y_pred_list[group_list==5], average=average)#, zero_division=0
    group5_recall = metrics.recall_score(label_list[group_list==5], y_pred_list[group_list==5], average=average)#, zero_division=0
    group5_f1_score = metrics.f1_score(label_list[group_list==5], y_pred_list[group_list==5], average=average)#, zero_division=0
    group5_accuracy = metrics.accuracy_score(label_list[group_list==5], y_pred_list[group_list==5])
    
    group6_precision = metrics.precision_score(label_list[group_list==6], y_pred_list[group_list==6], average=average)#, zero_division=0
    group6_recall = metrics.recall_score(label_list[group_list==6], y_pred_list[group_list==6], average=average)#, zero_division=0
    group6_f1_score = metrics.f1_score(label_list[group_list==6], y_pred_list[group_list==6], average=average)#, zero_division=0
    group6_accuracy = metrics.accuracy_score(label_list[group_list==6], y_pred_list[group_list==6])


    fairness_metric = {
                       'accuracy/group1_recall': group1_recall, 'accuracy/group1_precision': group1_precision, 
                       'accuracy/group1_f1-score': group1_f1_score ,
                       'accuracy/group2_recall': group2_recall, 'accuracy/group2_precision': group2_precision, 
                       'accuracy/group2_f1-score': group2_f1_score ,
                       'accuracy/group3_recall': group3_recall, 'accuracy/group3_precision': group3_precision, 
                       'accuracy/group3_f1-score': group3_f1_score ,
                       'accuracy/group4_recall': group4_recall, 'accuracy/group4_precision': group4_precision, 
                       'accuracy/group4_f1-score': group4_f1_score ,
                       'accuracy/group5_recall': group5_recall, 'accuracy/group5_precision': group5_precision, 
                       'accuracy/group5_f1-score': group5_f1_score ,
                       'accuracy/group6_recall': group6_recall, 'accuracy/group6_precision': group6_precision, 
                       'accuracy/group6_f1-score': group6_f1_score,
                       'group1_accuracy':group1_accuracy,
                       'group2_accuracy':group2_accuracy,
                       'group3_accuracy':group3_accuracy,
                       'group4_accuracy':group4_accuracy,
                       'group5_accuracy':group5_accuracy,
                       'group6_accuracy':group6_accuracy
...
def compute_fairness_metrics(label_list, y_pred_list, group_list, zero_division=0, average='macro'):
    num_classes = max(label_list.max(), y_pred_list.max())+1
    tn, fn, tp, fp = get_cm_values(label_list, y_pred_list, num_classes)
    # just want to get the weighted sum
    true_sum = tp + fn
    weights = true_sum
    group0_precision = metrics.precision_score(label_list[group_list==0], y_pred_list[group_list==0], average=average)#, zero_division=0
    group0_recall = metrics.recall_score(label_list[group_list==0], y_pred_list[group_list==0], average=average)#, zero_division=0
    ...
    F1 = metrics.f1_score(label_list, y_pred_list, average=average)
    ...
    group0_f1_score = metrics.f1_score(label_list[group_list==0], y_pred_list[group_list==0], average=average)#, zero_division=0
    group1_f1_score = metrics.f1_score(label_list[group_list==1], y_pred_list[group_list==1], average=average)#, zero_division=0
